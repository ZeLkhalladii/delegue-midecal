        ...
        <div>
            <section className="ml-5">
                    ...
                    <h1 className="text-center text-4xl text-black font-medium leading-snug tracking-wider">
                        UPGRADE YOUR SELLING PACK
                    </h1>
                    <p className="text-center text-lg text-gray-700 mt-2 px-6">
                        Increase your products listing limit and enhance your delivery by upgrading your Seller Pack
                    </p>
                    ...
                    <div className="max-w-full md:max-w-6xl mx-auto my-3 md:px-8">
                        ...
                        <div className="w-11/12 max-w-sm sm:w-3/5 lg:w-1/3 sm:my-5 my-8 relative z-0 rounded-lg shadow-lg md:-mr-4">
                            ...
                            <div className="block text-left text-sm sm:text-md max-w-sm mx-auto mt-2 text-black px-8 lg:px-6">
                                ...
                                This is the starter pack that you get just by signing in  as a seller.
                                Make you benefits of a standard Delivery and 10 products limit
                            </div>
                            <div className="flex flex-wrap mt-3 px-6">
                                ...
                                <li className="flex items-center">
                                    ...
                                    <span className="text-gray-700 text-lg ml-3">Standard Delivery</span>
                                </li>
                                <li className="flex items-center">
                                    <div className=" rounded-full p-2 fill-current text-green-700">
                                    <svg className="w-6 h-6 align-middle" width={24} height={24} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
                                    ...
                                    <span className="text-gray-700 text-lg ml-3">10 Products limit</span>
                                </li>
                                </ul> 
                            </div>  
                        ...
                        <div className="w-full max-w-md sm:w-2/3 lg:w-1/3 sm:my-5 my-8 relative z-10 bg-white rounded-lg shadow-lg">
                            ...
                            <h2 className="text-sm text-gray-500 text-center pb-6"><span className="text-3xl">499$</span></h2>
                            The most popular Pack. You can buy it as a new seller or you can get it buy making more than 2000$ from
                            sales.
                            </div>
                            ...
                            <ul>
                                ...
                                <span className="text-gray-700 text-lg ml-3">Express Delivery</span>
                                </li>
                                <li className="flex items-center">
                                <div className=" rounded-full p-2 fill-current text-green-700">
                                    <svg className="w-6 h-6 align-middle" width={24} height={24} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
                                ...
                                <span className="text-gray-700 text-lg ml-3">Illimited products</span>
                                </li>
                            </ul>
                            </div>
                            <div className="block flex items-center p-8  uppercase">
                ...
                px-6 py-3 block shadow-xl hover:bg-gray-700">
                        ...
                        <div className="w-11/12 max-w-sm sm:w-3/5 lg:w-1/3 sm:my-5 my-8 relative z-0 rounded-lg shadow-lg md:-ml-4">
                            ...
                            <div className="block text-left text-sm sm:text-md max-w-sm mx-auto mt-2 text-black px-8 lg:px-6">
                                ...
                                <h2 className="text-sm text-gray-500 text-center pb-6">299$</h2> 
                                The Pro Pack. You can buy it as a new seller or you can get it buy making more than 500$ from
                            sales.
                            </div>
                            <div className="flex flex-wrap mt-3 px-6">
                                <ul>
                                ...
                                <li className="flex items-center">
                                    ...
                                    <span className="text-gray-700 text-lg ml-3">50 Products limit</span>
                                </li>
                                </ul>
                            </div>
                            <div className="block flex items-center p-8  uppercase">
